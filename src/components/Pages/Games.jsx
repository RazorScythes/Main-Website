            ...
            <div className={`${styles.boxWidthEx}`}>
                <div className="container mx-auto file:lg:px-8 relative px-0">
                    <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5 place-content-start text-center my-10">
                        <div className='lg:w-[350px] md:[300px] sm:w-[325px] xs:w-[350px] mx-auto h-[275px] relative'>
                            ...
                            <div className='absolute left-0 top-0 py-6 px-4'>
                                <div className='flex flex-row flex-wrap break-keep'>
                                    <Link to={`/tag/adventure`}><p className='text-white px-4 rounded-full py-1 mb-2 mr-2 bg-gray-800 xs:text-sm text-xs font-semibold'>18+</p></Link>
                                    <Link to={`/tag/adventure`}><p className='text-white px-4 rounded-full py-1 mb-2 mr-2 bg-gray-800 xs:text-sm text-xs font-semibold'>adventure</p></Link>
                                    <Link to={`/tag/adventure`}><p className='text-white px-4 rounded-full py-1 mb-2 mr-2 bg-gray-800 xs:text-sm text-xs font-semibold'>rpg</p></Link>
                                    <Link to={`/tag/adventure`}><p className='text-white px-4 rounded-full py-1 mb-2 mr-2 bg-gray-800 xs:text-sm text-xs font-semibold'>puzzel</p></Link>
                                    <Link to={`/tag/adventure`}><p className='text-white px-4 rounded-full py-1 mb-2 mr-2 bg-gray-800 xs:text-sm text-xs font-semibold'>simulation</p></Link>
                                </div>
